    ...
    return (
        <div className="bg-gray-200 dark:bg-gray-900">
            <div className="ml-5 md:ml-20 mt-20">
                ...
                <div>
                    <p className="mt-5 md:ml-5 text-lg md:text-4xl px-10 dark:text-white leading-normal text-semibold">
                ...
                <div className="grid grid-cols-10 gap-4 mt-16 pb-20">
                    <div className="col-span-3">
                        <h3 className="text-lg md:text-3xl dark:text-white font-semibold">
                            Contact
                        </h3>
                        <p className="text-sm md:text-xl dark:text-white mt-10">
                        ...
                        <h3 className="text-lg md:text-3xl dark:text-white font-semibold mt-10">
                            Job Opportunites
                        </h3>
                    ...
                    <div className="col-span-6">
                        <p className="md:text-2xl mx-4 md:mx-10 dark:text-white">
                        ...
                        <div>
                            <h2 className="text-lg md:text-4xl dark:text-white font-semibold mt-10 ml-10">
