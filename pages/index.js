            ...
            <div className="grid md:grid-cols-3">
                <div className="mx-5 md:ml-20 mt-10 md:mt-40 md:col-span-2">
                    <h1 className="text-4xl md:text-7xl font-semibold group text-skyblue_ dark:text-yellow_ hover:text-darkblue_ dark:hover:text-green_ transition-all duration-300 cursor-pointer">
                        ...
                        <br/>
                        <span
                            className="block max-w-0 group-hover:max-w-xs transition-all duration-500 h-2 bg-skyblue_ dark:bg-yellow_"></span>
                        Myself Ibrahim Ghasia.
                        <span
                            className="block max-w-0 group-hover:max-w-3xl transition-all duration-500 h-2 bg-skyblue_ dark:bg-yellow_"></span>
                    </h1>
                    ...
                    <div className="text-center mt-8">
                        <Link href="/about">
                            <button
                                ...
                                <span
                                    className="relative px-10 py-3 transition-all ease-in duration-75 bg-white dark:bg-gray-900 rounded-md group-hover:bg-opacity-0 text-lg">
                                    About Me 🙋🏼
                                </span>
                            </button>
                        </Link>
